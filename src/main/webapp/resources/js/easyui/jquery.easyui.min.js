...
//---------------以下是增加的内容-------------------
var cell_width = 25;  
if((_66f+"").length > 4 && (_66f+"").length < 7){  
cell_width = 35;  
}else if((_66f+"").length > 6 && (_66f+"").length < 9){  
cell_width = 50;  
}else if((_66f+"").length > 8 && (_66f+"").length < 11){  
cell_width = 65;  
}  
cc.push("<td class=\"datagrid-td-rownumber\"><div style='width:"+cell_width+"px' class=\"datagrid-cell-rownumber\">"+_66f+"</div></td>");  
